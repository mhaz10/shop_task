...
import 'package:shop_app_task/features/offers/cubit/offers_cubit.dart';
      ...
      body: BlocBuilder<OffersCubit, OffersState>(
        builder: (context, state) {
          if (state is GetDataSuccess) {
            List<CategoryModel> categories = context.read<OffersCubit>().categories!;
            List<ProductModel>? products = context.read<OffersCubit>().products!;
            return SafeArea(
              child: Padding(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            SizedBox(
                              width: AppResponsive.width(context, value: 8),
                            ),
                            Text(
                      ...
                      GridView.builder(
                        ...
                        itemBuilder: (context, index) => CustomItem(product: products[index],),
            ...
            return Center(
              child: Text(state.error, style: AppTextStyle.font16Bold.copyWith(color: AppColors.red),),
            );
          }
